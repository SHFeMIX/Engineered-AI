...
site: "Cursor"
published: 2023-07-20T16:11:00.000Z, 2023-07-20T16:11:00.000Z
source: "https://cursor.com/blog/llama-inference"
domain: "cursor.com"
language: "en-US"
word_count: 3508
---
...
![Figure 1: GPT-3.5 dominates Llama in all benchmarks here.](https://cursor.com/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fllama-inference-0.png&w=1920&q=70)
...
![Figure 2: Each datapoint measures a different batch size. For prompt tokens, we always do far better on pricing than gpt-3.5, but trail slightly behind on gpt-3.5's latency of 0.4s for 3.6K tokens.](https://cursor.com/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fllama-inference-1.png&w=1920&q=70)
...
As we can see the price is *significantly* better than GPT-3.5’s $0.0015/1k tokens! It does look like we lag a bit behind on time to first token for longer sequences, but the solve is quite straightforward. Parallelizing Llama across 8 GPTs (instead of 2) would give us an almost 4x speedup, meaning Llama-2 dominates GPT-3.5 for prompts!
...
![Figure 3: For all datapoints, we measure price per generated tokens when generating 512 tokens.](https://cursor.com/marketing-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fllama-inference-2.png&w=1920&q=70)
