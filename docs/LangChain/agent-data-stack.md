...
site: "LangChain Blog"
published: "2026-07-28T03:27:00.000Z"
...
](https://www.langchain.com/blog)[Create agents](https://www.langchain.com/blog/agent-data-stack#)

Share

![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/6a683de0377180aefcf29d7e\_thumbnail1.png)
...
We ended up choosing [Hex](https://hex.tech/). It worked for dashboards, notebooks, and conversational analysis, which made it easier to choose a single central data workspace.
...
- CLI workflows
- MCP
- [LangSmith Fleet](https://www.langchain.com/langsmith/fleet), through MCP and CLI integrations
...
Today, 100% of the company uses our agent-first data stack, [via Hex](https://hex.tech/customers/langchain/), in some form.
...
![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/6a683f25ac13a63e612e43df\_thumbnail2.png)

LangChain's data stack architecture

### How we define the data models

[dbt](https://www.getdbt.com/) is one of the main places where we manage context about our data models. That context exists in both SQL and written definitions.
...
Context needs a feedback loop. We wanted a way to see how people are using the agent and where the agent needs more help. Observability tools help with this. We leverage Context Studio from Hex, but teams can use [LangSmith](https://docs.langchain.com/langsmith/observability) if their data agent is built in-house. We can look at trends in conversation topics, common warnings, issues, and context gaps. This data helps us decide where to improve the stack.
...
![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/6a683fde0d607210b7d6cb8f\_thumbnail3.png)
