---
title: "Introducing Cursor Start · Cursor"
site: "Cursor"
published: "2026-07-28T12:00:00.000Z, 2026-07-28T12:00:00.000Z"
...
- **Generous access to Cursor models.** Run [Grok 4.5](https://cursor.com/blog/grok-4-5), our most powerful Cursor model, and [Composer](https://cursor.com/blog/composer-2-5), our most price-efficient coding model.
- **More agent requests than the Free plan**, across desktop, web, iOS, and the CLI, so you can build every day.
- **Always-on [cloud agents](https://cursor.com/docs/cloud-agent).** Kick off long-running cloud agents that build, test, and open pull requests while you keep working.
- **[Cursor for iOS](https://cursor.com/docs/cloud-agent/mobile).** Launch agents or control existing ones from your phone, then pick the work back up on your desktop.
...
To compare across all plans and see a more detailed view of what's included, visit [cursor.com/pricing](https://cursor.com/pricing).

## Getting started

Cursor Start is available today for developers in India at [cursor.com/pricing](https://cursor.com/pricing).

Existing Free users in India can upgrade their plan from the [dashboard](https://cursor.com/api/auth/checkoutDeepControl?tier=express). New users in India can visit [cursor.com/signup](https://cursor.com/signup) and select the Start plan during onboarding. Pay in INR with UPI, credit, or debit card.
