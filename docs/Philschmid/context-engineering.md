...
- **Available Tools:** Definitions of all the functions or built-in tools it can call (e.g., check\_inventory, send\_email).
...
- Tools for send\_invite or send\_email.
...
- [Context Engineering for Agents](https://rlancemartin.github.io/2025/06/23/context\_engineering/)
