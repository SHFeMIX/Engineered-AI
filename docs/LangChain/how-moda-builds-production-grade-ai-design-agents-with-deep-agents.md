...
site: "LangChain Blog"
published: 2026-03-24T17:07:54.000Z
...
1. **Design Agent:** the primary agent behind the Cursor-style sidebar, handling all real-time design creation and iteration on the canvas
2. **Research Agent:** fetches and stores structured content from external sources (e.g., a company's website) into a per-user file system within Moda
