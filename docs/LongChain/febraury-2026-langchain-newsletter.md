...
source: "https://blog.langchain.com/febraury-2026-langchain-newsletter/"
...
⚙️ Configure which parts of a trace’s inputs and outputs appear directly in the tracing table. [Learn more.](https://docs.langchain.com/langsmith/configure-input-output-preview?utm_source=hs_email&utm_medium=email&_hsenc=p2ANqtz-97KERjwtEwc832AmNU8y5gNmj3XBly2OHhdZRpzmFkqJBT-_41P-uLU9VGgBiR9eOUo7SL)

👀 Schedule reports to run daily, weekly, or on a custom cadence with Insights Agent. [Learn more.](https://docs.langchain.com/langsmith/insights?utm_source=hs_email&utm_medium=email&_hsenc=p2ANqtz-97KERjwtEwc832AmNU8y5gNmj3XBly2OHhdZRpzmFkqJBT-_41P-uLU9VGgBiR9eOUo7SL#schedule-insights-reports)

📌 Pin any experiment as your baseline and instantly see performance deltas across every run without manual side-by-side comparison. [Learn more.](https://docs.langchain.com/langsmith/analyze-an-experiment?utm_source=hs_email&utm_medium=email&_hsenc=p2ANqtz-97KERjwtEwc832AmNU8y5gNmj3XBly2OHhdZRpzmFkqJBT-_41P-uLU9VGgBiR9eOUo7SL#set-a-baseline-in-the-experiments-view)
...
![](https://blog.langchain.com/content/images/2026/03/pm-cycle-diagram--3--1.png)
...
Get started in seconds with Claude Agent SDK, OpenAI, LangChain, Vercel AI SDK, and 20+ other frameworks. Pick your stack, copy the code, start debugging. [Get started here.](https://docs.langchain.com/langsmith/integrations?utm_source=hs_email&utm_medium=email&_hsenc=p2ANqtz-97KERjwtEwc832AmNU8y5gNmj3XBly2OHhdZRpzmFkqJBT-_41P-uLU9VGgBiR9eOUo7SL)
