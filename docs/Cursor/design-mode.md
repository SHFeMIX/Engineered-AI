---
title: "Direct agents with visual prompts in Design Mode · Cursor"
site: "Cursor"
published: "2026-06-05T00:00:00.000Z, 2026-06-05T00:00:00.000Z"
...
From the [Cursor browser](https://cursor.com/blog/browser-visual-editor), you can click any element, draw on the page, or describe the change by voice, and Cursor gets the context it needs to edit the code while you move on to the next edit.
...
This flow works best with a model that can make targeted UI changes quickly. [Composer 2.5](https://cursor.com/blog/composer-2-5) excels at this because it is both fast and strong at interface work. As agents finish, the app hot reloads. You see the changes appear in the running product and keep going until the interface feels right.
...
Try Design Mode in the [Agents Window](https://cursor.com/docs/agent/agents-window). Read the [Browser docs](https://cursor.com/docs/agent/browser) to learn more, or [download Cursor](https://cursor.com/download) to get started.
