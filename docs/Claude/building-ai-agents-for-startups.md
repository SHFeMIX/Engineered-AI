...
[**ClassDojo**](https://claude.com/customers/classdojo), the education platform serving 45 million users across 90% of US elementary schools, uses Claude to power its Sidekick AI teaching assistant. It compresses admin work that used to take teachers 20-30 minutes per class roster down to seconds.
