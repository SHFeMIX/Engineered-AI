---
title: "Why Fleet Has General Purpose Chat and Specialized Agents"
site: "LangChain Blog"
published: "2026-06-16T14:45:00.000Z"
source: "https://www.langchain.com/blog/why-fleet-has-both-general-purpose-chat-and-specialized-agents"
domain: ""
language: "en"
word_count: 1344
---
...
](https://www.langchain.com/blog)[Create agents](https://www.langchain.com/blog/why-fleet-has-both-general-purpose-chat-and-specialized-agents#)

Share

![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/6a30ab136469e78525730f65\_fleet-agent-types.png)
...
![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/6a30ac0499037b82d92e72fa\_Group%202147239397.png)
...
![](https://cdn.prod.website-files.com/65c81e88c254bb0f97633a71/6a30ac122836d98c11a91b6b\_Group%202147239396.png)
...
**Models:** You can choose the model for the main agent and for individual subagents. A [supervisor agent](https://www.langchain.com/blog/choosing-the-right-multi-agent-architecture) might use a stronger model for planning or review, then smaller models for narrower subtasks. this allows you to optimize model selection for speed, cost, and performance.
...
| Use Case | General Purpose Chat | Specialized Agent |
| --- | --- | --- |
| Agent is best for | One-off, exploratory, or ad hoc work | Recurring, scheduled, or event-driven work |
| Agent setup | None. Start with a request. | Configure instructions, tools, skills, model, and triggers. Fleet can configure these for you with AI, or you can do so manually. |
| Tools | Can use available workspace integrations | Scoped to the tools needed for the job |
| Subagents | Can use generic subagents | Can define custom subagents with independent models, tools and prompts |
| Skills | Workspace skills | Workspace skills and private agent skills |
| Memory | Thread-level context | Persistent memory scoped to the agent's job and thread-level context |
| Computer Access | Enabled per thread | Chosen as part of the agent environment and configured as either per-thread or per-agent |
...
To get started, you can [try Fleet free](https://smith.langchain.com/agents?skipOnboarding=true). To dive into more of the technical details, [read the docs](https://docs.langchain.com/langsmith/fleet).
