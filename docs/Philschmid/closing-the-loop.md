...
Researchers call this situational awareness ([Berglund et al., 2023](https://arxiv.org/abs/2309.00667)) or *meta-cognition*. Anthropic's introspection research ([Oct 2025](https://www.anthropic.com/research/introspection)) showed that Claude can tell whether outputs were artificially injected or generated by it. Not in a human sense, but as a mechanism that produces better meta-task behavior.
