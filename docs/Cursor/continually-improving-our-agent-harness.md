...
\<video width="1200" height="630"\>\<source src="https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/blog/blog-customizing-harness-anim-20260428.mp4" type="video/mp4"\>\</video\>
...
When we get early access to new models, all of these approaches converge. We spend weeks customizing our harness to a model's strengths and quirks until the same model inside our specially tuned harness is noticeably faster, smarter, and more efficient than it would be on its own.
...
![In a focused sprint earlier this year, we drove all tool calls to at least 2 or often 3 9s of reliability.](https://cursor.com/marketing-static/\_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fchart-tool-error-rates.png&w=1920&q=70)
...
![Preventing models from calling tools that aren't in its toolset](https://cursor.com/marketing-static/\_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fharness-model-switching-apr-2026-1.png&w=1920&q=70)
