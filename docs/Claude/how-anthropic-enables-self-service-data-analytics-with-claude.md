...
![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a20480bedac32484c00d6b9\_4a7645b6.png)
...
![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a2049920443016925a3ef72\_74528df2.png)

Standard data engineering practices like dimensional modeling are just as important as they ever were.

### Data foundations

The most important aspect of ensuring analytics agents are accurate is via strong data foundations, which include the data models, transforms, tests, and tables in a data warehouse, along with the metadata describing them. Standard data engineering and data quality practices such as [dimensional modeling](https://en.wikipedia.org/wiki/Dimensional\_modeling), shift-left testing, freshness and completeness checks on critical pipelines all still apply (and we won't relitigate these).

![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a2049920443016925a3ef75\_98412372.png)
...
### [Domain A] → \`references/[domain\_a].md\`
- **Use for**: [kinds of questions]
- **Key tables**: [...]
- **Dashboards**: \`references/[domain\_a]\_dashboards.json\`

### [Domain B] → \`references/[domain\_b].md\`
- **Use for**: [...]
