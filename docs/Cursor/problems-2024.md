---
title: "More problems · Cursor"
site: "Cursor"
published: 2024-05-25T23:58:00.000Z, 2024-05-25T23:58:00.000Z
...
As a follow-up to [our original problems post](https://www.cursor.com/blog/problems-2023), here are some more of the problems we believe matter most for the next phase of AI-programming.

Cursor comes with [Copilot++](https://www.cursor.com/agent#cpp), a more intelligent version of copilot that predicts your next edit. Can we take this idea to its natural limit?
...
- Additional inference tricks similar to [Speculative Edits](https://www.cursor.com/blog/instant-apply)
...
[Cmd-k](https://www.cursor.com/agent#cmd-k) is already fantastic, but what if you could ask for a generic edit across your entire codebase? In particular, one that accurately spans multiple files?
...
Maybe it looks like some variant of [transformer memory as a differentiable search index](https://arxiv.org/pdf/2202.06991). Perhaps something else entirely. It’s an underexplored research direction.
...
If any of these problems interest you, please reach out at [hiring@cursor.com](mailto:hiring@cursor.com)