---
title: "Build from anywhere with Cursor for iOS · Cursor"
site: "Cursor"
published: "2026-06-29T12:00:00.000Z, 2026-06-29T12:00:00.000Z"
...
[Get Cursor for iOS](https://apps.apple.com/app/cursor/id6767085653)
...
Beyond code, [cloud agents](https://cursor.com/docs/cloud-agent) produce demos, screenshots, and logs that make it easy to validate their work. When an agent is done, you can review these generated artifacts, inspect diffs, leave follow-up instructions, or merge the PR directly from the app.
...
Cursor for iOS is available now in public beta on all paid plans. Get 75% off on [Composer 2.5](https://cursor.com/docs/models/cursor-composer-2-5) runs in the mobile app now through July 5, 2026.

[Download for iOS](https://apps.apple.com/app/cursor/id6767085653) to start building from your phone, or read the [docs](http://cursor.com/docs/cloud-agent/mobile) to learn more.

![QR code to download Cursor for iOS](https://cursor.com/marketing-static/\_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fqr-code-mobile-final.png&w=384&q=70)

QR code to download Cursor for iOS
