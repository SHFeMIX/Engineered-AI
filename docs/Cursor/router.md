---
title: "Introducing Cursor Router · Cursor"
site: "Cursor"
published: "2026-07-22T00:00:00.000Z, 2026-07-22T00:00:00.000Z"
...
![Auto Intelligence quality and cost results compared to Fable, Opus 4.8, and GPT-5.6 Sol](https://cursor.com/marketing-static/\_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fchangelog%2Ffable-quality-results-light-1-.png&w=1920&q=70)
...
![Early access customer cost savings with Cursor Router versus Opus 4.8](https://cursor.com/marketing-static/\_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fchangelog%2Fearly-access-customers-light-1-.png&w=1920&q=70)
...
![Cost per commit for Balance, Auto Intelligence, Opus 4.8, and Fable](https://cursor.com/marketing-static/\_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fchangelog%2Fcost-per-light.png&w=1920&q=70)
...
Cursor Router is one piece of how Cursor drives token efficiency. Choosing the right model only matters if the agent itself stays lean, so we keep cutting waste in the [harness](https://cursor.com/blog/continually-improving-agent-harness) around it.

[Dynamic tool calling](https://cursor.com/blog/dynamic-context-discovery) is another clear example where most native tool descriptions are no longer loaded into every prompt. The model looks them up the first time it needs them, following the same pattern we already use for MCPs. This keeps common tools like read and edit hot while less commonly used tools only enter the prompt when the agent actually calls them.

Alongside Cursor Router, we keep raising the floor and the ceiling of the model pool: [Grok 4.5](https://cursor.com/blog/grok-4-5) widens what Cursor Router can draw from on harder, higher-cost work. Composer keeps getting better on the everyday path, so lower cost turns stay close to frontier quality without paying frontier prices.

Cursor Router is available today for Teams and Enterprise plans across desktop, web, iOS, CLI, and our SDK.

Read more in our [docs](https://cursor.com/docs/cursor-router) and [changelog](https://cursor.com/changelog/router).
