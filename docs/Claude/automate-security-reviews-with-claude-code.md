...
2 screenshots showing vulnerabilities that were caught by Claude Code, leaving comments in GitHub.
...
A GitHub comment showing a remote code execution vulnerability
...
A GitHub comment showing a SSRF attack vulnerability
